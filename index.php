        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                <div class="page-name 	mb-4">
                    <h4 class="m-0"><img src="<?php echo htmlspecialchars($profile_image_path); ?>" class="mr-1"
                            alt="profile" />Welcome <span><?php echo htmlspecialchars($name); ?></span></h4>
                                ...
                                <div>
                                    <div class="team-list ">
                                        <div class="team-view justify-content-between shadow-sm">
                                            ...
                                            <div class="mx-3">
                                                <a href="#" class="toggle-positions"
                                                    data-id="<?php echo $general['general_title']; ?>"><i
                                    ...
                                    <div>
                                        <div class="specific-positions"
                                            id="positions-<?php echo $general['general_title']; ?>"
                                            ...
                                            <div class="mb-3 filter-content-indiv">
                                                <div class="team-view shadow-sm">
                                                    <div class="team-img px-2 btn-light rounded-circle mx-2 disabled"
                                                        style="background:lightblue;">
                                                        <h4 class="text-body-tertiary">
                                                            <?php echo $specific['specific_position']; ?></h4>
                                                    </div>
                                                    <div class="team-content my-auto">
                ...
                <!-- History/Recent Activities and Interview cards -->
                <div class="row">
                        ...
                        <div class="card card-list flex-fill">
                            ...
                            <div class="card-body dash-activity">
                                <div class="slimscroll activity_scroll">
                                    ...
                                    <div
                                        class="d-flex flex-column align-items-center justify-content-center text-center min-height-200">
                                    ...
                                    <div class="activity-set d-flex align-items-start py-3 px-4">
                                        <div class="activity-img mr-3 align-self-center">
                                            <img src="<?php echo htmlspecialchars($activity['profile_image']); ?>"
                                                alt="avatar" class="rounded-circle">
                                        </div>
                                        <div class="activity-content w-100">
                                            <div class="d-flex justify-content-between w-100 mb-1">
                                                <span
                                                    class="font-weight-bold"><?php echo htmlspecialchars($activity['activity']); ?></span>
                                                <span
                                                    class="text-muted small"><?php echo htmlspecialchars($activity['formatted_timestamp']); ?></span>
                                            </div>
                                            <div>
                                                <?php echo htmlspecialchars($activity['name']) . ' has ' . htmlspecialchars($activity['activity']); ?>
                                            </div>
                                            <div class="text-muted mt-1">
                                                <?php echo htmlspecialchars($activity['details']); ?></div>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
                                ...
                                <div class="leave-viewall mt-3">
                                    <a href="view_history.php">View all <img src="assets/img/right-arrow.png"
                    ...
                    <div class="col-xl-4 col-sm-12 col-12 d-flex">
                        <div class="card card-list flex-fill">
                            ...
                            <div class="card-body p-0" style="max-height: 400px; overflow-y: auto;">
                                ...
                                <div class="leave-set d-flex align-items-center justify-content-between py-2 px-3">
                                    <div class="d-flex align-items-center">
                                        <span
                                            class="leave-active d-flex align-items-center justify-content-center rounded-circle shadow-sm bg-success text-white p-2 mr-2">
                                            <i class="fas fa-briefcase"></i>
                                        </span>
                                        <label
                                            class="mb-0"><?php echo htmlspecialchars($interview['interview_date']); ?> -
                                            <?php echo htmlspecialchars($interview['full_name']); ?></label>
                                    </div>
                                ...
                                <div class="leave-set d-flex align-items-center justify-content-between py-2 px-3">
                                    <div class="d-flex align-items-center">
                                        <span
                                            class="leave-inactive d-flex align-items-center justify-content-center rounded-circle shadow-sm bg-light text-muted p-2 mr-2">
                                            <i class="fas fa-briefcase"></i>
                                        </span>
                            ...
                            <div class="leave-viewall text-center py-2">
                                <a href="view_applicants.php">View all <img src="assets/img/right-arrow.png"
                                        class="ml-2" alt="arrow" /></a>
                            </div>
                        </div>
                    </div>
