<?php include("PHP_Connections/fetch_archives_jobs.php")?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        $experience_list = !empty($job['experience_requirements'])
                                            ...
                                            : '';
                                        $duties_list = !empty($job['duties_requirements'])
                                            ? '<ul><li>' . str_replace(', ', '</li><li>', htmlspecialchars($job['duties_requirements'])) . '</li></ul>'
                                            : '';
                                        $competencies_list = !empty($job['competencies_requirements'])
                                            ? '<ul><li>' . str_replace(', ', '</li><li>', htmlspecialchars($job['competencies_requirements'])) . '</li></ul>'
                                            : '';
                                        $eligibility_list = !empty($job['eligibility_requirements'])
                                            ? '<ul><li>' . str_replace(', ', '</li><li>', htmlspecialchars($job['eligibility_requirements'])) . '</li></ul>'
                                            : '';
                                        ?>
                                        <tr class="text-break">
                                            ...
                                            <td><?php echo $competencies_list; ?></td>
                                            <td><?php echo $eligibility_list; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="PHP_Connections/delete_job.php?id=<?php echo htmlspecialchars($job['jobarchive_id']); ?>"
                                        ...
                                        <tr class="text-center">
                                            <td colspan="17">No archived Jobs found.</td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
