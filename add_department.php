<?php include("PHP_Connections/insert_department.php")?>
                ...
                <div class="col-md-9 mx-auto my-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- START FORM -->
                            <form method="POST" action="add_department.php" enctype="multipart/form-data"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="d-flex justify-content-between mx-1 col-md-12">
                                        <button class="col-md-5 bwtn btn-info" type="submit">Add</button>
                                        <a href="view_departments.php" class="col-md-5 btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                            </form>
                            <!-- END FORM -->
