    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="archiveForm" method="get" action="PHP_Connections/archive_announcement.php">
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <a href="edit_announcement.php?announcement_id=<?php echo $announcement['announcement_id']; ?>"
                ...
                <div class="user-menu">
                    <a href="add_announcement.php" class="btn btn-info btn-lg float-add-btn" title="Add Announcement">
                ...
                <div class="mobile-user-menu show">
                    <a href="add_announcement.php" class="btn btn-info btn-lg float-add-btn px-3 py-2"
